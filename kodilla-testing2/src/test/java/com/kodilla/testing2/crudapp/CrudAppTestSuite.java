...
public class CrudAppTestSuite {
    private final static String BASE_URL = "https://marinder.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName)  throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("dkucharski1996@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("&ijhA&.Wf9rQu8J");
